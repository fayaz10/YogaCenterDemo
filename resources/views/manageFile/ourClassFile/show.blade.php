    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">  
                ...
                <div class="card-header"><h1>{{$ourClass->title}} 
                </h1><hr>
                 <img src="/storage/cover_image/{{$ourClass->cover_image}}">
                ...
                <div class="card-body">
                   ...
                   <p>{!!$ourClass->article!!}</p>
                   <hr>
                   <small>Created at: {{ $ourClass->created_at->diffForHumans() }}</small>
                   <small style="padding-left: 80px">URL:<a href="{{url('blog/'.$ourClass->slug)}}">here</a></small>
                   <small style="float: right">Last Update: {{$ourClass->updated_at->diffForHumans() }}</small>
                </div>
                <hr>
                <div class="container">
               ...
               @foreach($ourClass->comments as $com)
                     <tr>
