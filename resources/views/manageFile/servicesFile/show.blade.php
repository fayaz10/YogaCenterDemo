    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">  
                ...
                <div class="card-header"><h1>{{$services->title}} 
                </h1><hr>
                 <img src="/storage/cover_image/{{$services->cover_image}}">
                ...
                <div class="card-body">
                   ...
                   <hr>
                   <small>Created at: {{ $services->created_at->diffForHumans() }}</small>
                   <small style="padding-left: 80px">URL:<a href="{{url('blog/'.$services->slug)}}">here</a></small>
                   <small style="float: right">Last Update: {{$services->updated_at->diffForHumans() }}</small>
                </div>
                <hr>
                <div class="container">
               ...
               @foreach($services->comments as $com)
                     <tr>
